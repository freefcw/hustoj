...
<div class="row index">
    <div class="news">
        ...
        <div class="news-item">
            <h4><a href="/news/<?php echo($news->news_id);?>"><?php echo($news->title);?></a><?php if ($news->is_top_news()):?><span class="label label-danger">top</span><?php endif;?></h4>
            <div class="news-content readability">
                <?php if ( mb_strlen($news->content) > 150 ):?>
                <?php echo(mb_substr($news->content, 0, 100));?><a href="/news/<?php echo($news->news_id);?>" class="readmore">...</a>
                <?php else:?>
