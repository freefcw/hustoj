...
<div class="row">
    ...
    <div class="span3 user-stats">
        <ul class="nav nav-pills">
            <li class="stats active count-accept"><a><span class="count"><?php echo $u['solved'];?></span>accepted</a> </li>
            <li class="stats active count-submit"><a><span class="count"><?php echo $u['submit'];?></span>submission</a> </li>
        </ul>
    </div>
</div>
