...
by <a href="/u/<?php echo $the_topic['user_id'];?>"><?php echo $the_topic['user_id'];?></a>
~ <?php echo OJ::timesince($the_topic['date']);?>
<hr />
...
<div class="reply" id="reply-<?php echo $r['reply_id'];?>">
    <div class="reply-header">
        <a href="/u/<?php echo $r['user_id'];?>"><?php echo $r['user_id'];?></a> reply at <?php echo OJ::timesince($r['date']);?>
    </div>
